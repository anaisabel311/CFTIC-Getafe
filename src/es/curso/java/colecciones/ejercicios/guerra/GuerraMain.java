...
import Utilidades.Util_ConexionTB;
...
// MÉTODO CONECTA 
	...
	public void conecta() {
	    ...
	    Connection connection =Util_ConexionTB.conexion(url, username, password);
		...
		while (rs.next()) {
//			VehiculoGuerra vehiculo1 = new VehiculoGuerra();
			
			System.out.println(rs.getInt("id"), rs.getString("nombre"), rs.getDouble ("ataque"), rs.getDouble("defensa"), rs.getInt ("tipo"));
